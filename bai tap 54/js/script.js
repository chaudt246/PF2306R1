class QuizApp{
    constructor(){
        ...
        this.continueBtn = this.infoBox.querySelector('.buttons .continue');
    ...
    showInfoBox() {
        this.infoBox.classList.add("activeInfo"); //show info box
    }

    // if exitQuiz button clicked
    closeInfoBox(){
        this.infoBox.classList.remove("activeInfo"); //hide info box
    }

    // if continueQuiz button clicked
    startQuiz() {
        this.resultBox.classList.remove("activeInfo"); //hide info box
        this.questionCounter = 0;
        this.correctAnswers = 0;
        this.availableQuestions = [...this.questions];
        this.quizBox.classList.add("activeQuiz"); //show quiz box
    ...
    showQuestion() {
      ...
      showAnswer() {
        ...
        this.nextBtn.style.display = "block"; // Show the "next question" button
        clearInterval(this.timer);
        this.userAnswered = true;
    }
